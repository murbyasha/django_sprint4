...
class IndexListView(ListView):
    ...
    queryset = Post.objects.filter_posts().posts_comments()
...
class ProfileView(ListView):
    ...
    def get_queryset(self):
        ...
        posts = Post.objects.filter(author=author).count_comments()
...
class ProfileEditView(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        return reverse('blog:profile', kwargs={'username': self.kwargs[self.slug_url_kwarg]})
